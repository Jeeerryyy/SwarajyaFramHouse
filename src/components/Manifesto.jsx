    ...
    >
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        ...
        <motion.h2
          ...
          className="font-serif text-4xl md:text-6xl lg:text-7xl tracking-tighter text-[#1A2520] leading-[1] max-w-4xl"
        >
              ...
              >
                ...
                <motion.div
                  ...
                  className={`col-span-12 md:col-span-5 flex flex-col justify-center ${
                    flip ? "md:order-2 md:col-start-7" : "md:col-start-2"
                  }`}
                >
                  <div className="space-y-4">
                    ...
                    <motion.h3
                      ...
                      className="font-serif text-3xl md:text-4xl lg:text-5xl tracking-tight text-[#1A2520] leading-[1.08]"
                    >
                      {ch.title}
                    </motion.h3>
                    ...
                    <motion.p
                      variants={animateFadeUp}
                      className="text-sm md:text-base text-[#1A2520]/80 leading-relaxed max-w-md pt-2"
                    >
                      {ch.body}
                    </motion.p>
                  </div>
                ...
                <motion.div
                  ...
                  className={`col-span-12 md:col-span-5 ${
                    flip ? "md:order-1 md:col-start-2" : "md:col-start-7"
                  }`}
                >
