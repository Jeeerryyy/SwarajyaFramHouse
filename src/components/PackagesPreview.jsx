      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 md:mb-20">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-6xl lg:text-7xl tracking-tighter leading-[1] text-[#1A2520] max-w-3xl">
          ...
          <Link
            ...
            className="group inline-flex items-center gap-3 text-xs uppercase tracking-[0.28em] text-[#1A2520] hover:text-[#C46549] transition-colors"
          >
            View all packages
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {PACKAGES.map((p, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden border border-[#D5D1C4] bg-[#EAE7DE] aspect-[4/3]"
            ...
            >
              ...
              <div className="absolute top-6 left-6 text-[10px] uppercase tracking-[0.3em] text-white/85">
                {p.number} / {p.subtitle}
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 flex items-end justify-between gap-4">
                <div>
                  ...
                  <p className="text-[10px] uppercase tracking-[0.28em] text-[#C46549] mt-2">
                    From {p.priceWeekday} · {p.unit}
                  </p>
                </div>
                <Link
                  to="/packages"
                  className="inline-flex items-center justify-center w-11 h-11 border border-white/60 text-white hover:bg-[#C46549] hover:border-[#C46549] transition-colors"
