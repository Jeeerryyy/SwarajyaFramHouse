...
export default function Amenities() {
  return (
    <section
      id="amenities"
      className="relative bg-[#EAE7DE] py-12 md:py-20"
      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 md:mb-20">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-6xl lg:text-7xl tracking-tighter text-[#1A2520] leading-[1] max-w-3xl">
        ...
        {/* Bento grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-6 auto-rows-[260px] md:auto-rows-[320px]">
          {AMENITIES.map((a, i) => (
            <motion.div
              key={a.id}
              ...
              className={`relative overflow-hidden group border border-[#D5D1C4] ${a.span}`}
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <p className="text-xs md:text-sm text-white/85 mt-1 max-w-xs">
                  {a.caption}
                </p>
              </div>
            </motion.div>
