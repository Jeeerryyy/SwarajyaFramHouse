...
export const PACKAGES = [
  {
    ...
    image: "/gallery/pool-swarajya-mural.jpeg",
  ...
  },
  {
    ...
    image: "/gallery/sahyadri-landscape.jpeg",
  ...
  },
  {
    ...
    image: "/gallery/pool-mountain-view.jpeg",
...
export const TESTIMONIALS = [
  {
    name: "leena phule",
    title: "Amazing surroundings & hospitality",
    quote: "The place and surroundings are amazing. The food is delicious and the portion size is more than enough. The staff and their hospitality is welcoming and very accommodating. Great experience, looking forward to visiting again!",
    rating: 5,
  ...
  {
    name: "Ajay Kodeesvaran",
    title: "Unlimited food & amazing pool",
    quote: "Worth the money. Unlimited food is best in this place. They provide unlimited food and starters — great quantity and taste! Amazing place to visit with friends. The pool is pretty decent.",
    rating: 4,
    source: "Google Review",
    time: "11 months ago",
    avatar: "A",
  ...
  {
    name: "shriram more",
    title: "Clean place & fresh food",
    quote: "Nice and clean place for family get-togethers! Food quality is fresh and delicious. Highly recommended for family outings.",
    rating: 5,
    source: "Google Review",
    time: "4 months ago",
    avatar: "S",
  ...
  {
    name: "Subhash Patil",
    title: "Great for big group events",
    quote: "It's a good place to have a get-together of around 75 persons. Spacious, well-managed, and beautiful location.",
    rating: 4,
    source: "Google Review",
    time: "4 months ago",
    avatar: "S",
  ...
  {
    name: "Atish S. Chate",
    title: "Relaxation with family & friends",
    quote: "Nice place to visit with families and friends for get-togethers and relaxation. Peaceful vibe near Sinhagad Fort.",
    rating: 5,
    source: "Google Review",
    time: "4 months ago",
    avatar: "A",
  ...
  },
  {
    ...
    quote: "Clean swimming pool and rooms, AC working perfectly, well organised, large parking area, food was tasty, staff polite and owner very friendly.",
    rating: 5,
    source: "Google Review",
    time: "Recent Stay",
    avatar: "R",
  ...
  },
  {
    ...
    quote: "We celebrated our son's 5th birthday here. The food taste was awesome, hospitality was excellent, and the AC hall, swimming pool, and cleanliness were top-notch.",
    rating: 5,
    source: "Google Review",
    time: "Family Event",
    avatar: "S",
  ...
  {
    name: "Yogesh Jadhav",
    title: "Peaceful location & boys outing",
    quote: "We recently visited this resort for a boys' outing. The biggest highlight is definitely its location — peaceful, beautiful, and a great break from city routine.",
    rating: 5,
    source: "Google Review",
    time: "Group Outing",
    avatar: "Y",
