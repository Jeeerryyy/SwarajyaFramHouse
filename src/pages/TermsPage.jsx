            ...
            <div className="legal-content">
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  on this Website, under these Terms, Swarajya Farm House and/or
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  and Swarajya Farm House may further restrict access by you to any
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  by displaying it, you grant Swarajya Farm House a non-exclusive,
                ...
                <p>
                  ...
                  third party’s rights. Swarajya Farm House reserves the right to
              ...
              <section className="legal-section">
                ...
                <p>
                  This Website is provided “as is,” with all faults, and Swarajya
                  Farm House makes no express or implied representations or
              ...
              <section className="legal-section">
                ...
                <p>
                  In no event shall Swarajya Farm House, nor any of its officers,
                  ...
                  Swarajya Farm House, including its officers, directors and
              ...
              <section className="legal-section">
                ...
                <p>
                  You hereby indemnify to the fullest extent Swarajya Farm House
              ...
              <section className="legal-section">
                ...
                <p>
                  Swarajya Farm House is permitted to revise these Terms at any
                  time as it sees fit, and by using this Website you are expected
                  to review such Terms on a regular basis to ensure you understand
              ...
              <section className="legal-section">
                <h2>10. Assignment</h2>
                <p>
                  Swarajya Farm House shall be permitted to assign, transfer, and
                  ...
                  not be permitted to assign, transfer, or subcontract any of
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  between Swarajya Farm House and you in relation to your use of
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  jurisdiction of the state and federal courts located in Pune,
